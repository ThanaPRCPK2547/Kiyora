...
# จัดการค่าว่างในกลุ่มปัจจัย (Factors)
factor_cols = [
...
# เติมค่าว่างในคอลัมน์ข้อความด้วย 'None'
...
# จัดรูปแบบมาตรฐาน: จัดกลุ่มจังหวัด
...
# จัดรูปแบบมาตรฐาน: จัดกลุ่มอาชีพ
...
# ทำ One-Hot Encoding สำหรับคำตอบที่เลือกได้หลายข้อ: ปัญหาผิว
...
print("4. การถมค่าว่างให้กับตัวแปรเป้าหมาย (Target Imputation)...")
target_col = 'brand_primary'
# ตรวจสอบให้แน่ใจว่าคอลัมน์ที่จำเป็นสำหรับ Random Forest มีครบถ้วน
feature_cols = ['gender_female', 'gender_male', 'age_encoded', 'monthly_income_encoded', 'acne_level_encoded']
# ตรวจสอบให้แน่ใจว่าไม่มีค่าว่างก่อนนำไปรันโมเดล RF
data[feature_cols] = data[feature_cols].fillna(0)

# หากคอลัมน์ 'uses_cleansing_water' ไม่มีอยู่ ให้ใช้ตรรกะสำรอง
...
# เลือกเฉพาะฟีเจอร์ตัวเลขสำหรับการคัดเลือก
